...
namespace LocalBackend.Migrations
{
    ...
    [Migration("20250702171652_NuevaMigracion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LocalShared.Entities.Administracion.ClsMAsignacionActividad", b =>
                {
                    b.Property<Guid>("IdAsignacionActividad")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<Guid>("ActividadUsuarioId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("EstadoAsignacion")
                        .HasColumnType("bit");

                    b.HasKey("IdAsignacionActividad");

                    b.HasIndex("ActividadId");

                    b.HasIndex("ActividadUsuarioId");

                    b.ToTable("AsignacionActividad");
                });

            modelBuilder.Entity("LocalShared.Entities.Administracion.ClsMListaActividades", b =>
                {
                    b.Property<Guid>("IdListaActividades")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("IdListaActividades");

                    b.ToTable("ListaActividades");
                });

            modelBuilder.Entity("LocalShared.Entities.Administracion.ClsMUpa", b =>
                {
            ...
            modelBuilder.Entity("LocalShared.Entities.Administracion.ClsMUsuario", b =>
                {
            ...
            modelBuilder.Entity("LocalShared.Entities.Administracion.ClsMAsignacionActividad", b =>
                {
                    b.HasOne("LocalShared.Entities.Administracion.ClsMListaActividades", "Actividad")
                        .WithMany()
                        .HasForeignKey("ActividadId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LocalShared.Entities.Administracion.ClsMUsuario", "ActividadUsuario")
                        .WithMany()
                        .HasForeignKey("ActividadUsuarioId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Actividad");

                    b.Navigation("ActividadUsuario");
                });

            modelBuilder.Entity("LocalShared.Entities.Administracion.ClsMUsuario", b =>
                {
                    b.HasOne("LocalShared.Entities.Administracion.ClsMUpa", "Upa")
                        .WithMany()
                        .HasForeignKey("UpaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
