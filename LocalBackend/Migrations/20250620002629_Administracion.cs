    ...
    public partial class Administracion : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdListaActividades = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListaActividades", x => x.IdListaActividades);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Upa", x => x.IdUpa);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Estado = table.Column<bool>(type: "bit", nullable: false),
                    UpaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NumIntentos = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Usuario", x => x.IdUsuario);
                    table.ForeignKey(
                        name: "FK_Usuario_Upa_UpaId",
                        column: x => x.UpaId,
                        principalTable: "Upa",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdAsignacionActividad = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ActividadId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ActividadUsuarioId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EstadoAsignacion = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AsignacionActividad", x => x.IdAsignacionActividad);
                    table.ForeignKey(
                        name: "FK_AsignacionActividad_ListaActividades_ActividadId",
                        column: x => x.ActividadId,
                        principalTable: "ListaActividades",
                        principalColumn: "IdListaActividades",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AsignacionActividad_Usuario_ActividadUsuarioId",
                        column: x => x.ActividadUsuarioId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AsignacionActividad_ActividadId",
                table: "AsignacionActividad",
                column: "ActividadId");

            migrationBuilder.CreateIndex(
                name: "IX_AsignacionActividad_ActividadUsuarioId",
                table: "AsignacionActividad",
                column: "ActividadUsuarioId");
