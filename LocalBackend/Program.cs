...
using LocalBackend.Repositories.UnitsOfWork.implementation.Administracion;
...
builder.Services.AddScoped<IUpaRepository, UpaRepository>();
builder.Services.AddScoped<IUpaUnitOfWork, UpaUnitOfWork>();

builder.Services.AddScoped<IUsuarioRepository, UsuarioRepository>();
builder.Services.AddScoped<IUsuarioUnitOfWork, UsuarioUnitOfWork>();

builder.Services.AddScoped<IAsignacionActividadRepository, AsignacionActividadRepository>();
builder.Services.AddScoped<IAsignacionActividadUnitOfWork, AsignacionActividadUnitOfWork>();
