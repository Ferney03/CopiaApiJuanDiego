...
namespace LocalBackend.Data
{
...

    {
        ...
        //Administracion
        public DbSet<ClsMAsignacionActividad> AsignacionActividad { get; set; }
        public DbSet<ClsMListaActividades> ListaActividades { get; set; }
        public DbSet<ClsMUpa> Upa { get; set; }
        public DbSet<ClsMUsuario> Usuario { get; set; }
